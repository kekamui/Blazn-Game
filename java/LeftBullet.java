...
public class LeftBullet extends GameObject
{
	...
	public LeftBullet(CopyOnWriteArrayList<Slender> slender,CopyOnWriteArrayList<Slender> slender1,CopyOnWriteArrayList<Slender> slender2, Boss boss,CopyOnWriteArrayList<box> boxes,int x, int y,int width, int height, String img)
	{
	...
	void update(Shooter shooter)
	{
		...
		for(box box: boxes)
		{
			...
			{
				shooter.leftbullets.remove(this);
			}
