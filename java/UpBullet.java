...
public class UpBullet extends GameObject
{
	...
	public UpBullet(CopyOnWriteArrayList<Slender> slender,CopyOnWriteArrayList<Slender> slender1,CopyOnWriteArrayList<Slender> slender2,Boss boss,CopyOnWriteArrayList<box> boxes, int x, int y,int width, int height, String img)
	{
