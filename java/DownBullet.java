...
public class DownBullet extends GameObject
{
	...
	public DownBullet(CopyOnWriteArrayList<Slender> slender,CopyOnWriteArrayList<Slender> slender1,CopyOnWriteArrayList<Slender> slender2, Boss boss, CopyOnWriteArrayList<box> boxes,int x, int y,int width, int height, String img)
	{
	...
	void update(Shooter shooter)
	{
		for(box box: boxes)
		{
			...
			{
				shooter.downbullets.remove(this);
			}
